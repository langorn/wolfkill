...
// ]
  ...
  function initTexture(){
    loader
      ...
      .add("static/images/shocked.jpg")
      .add("static/images/eye.png")
      .add("static/images/protect.png")
      // .add("static/images/whitewolf.png")
      .load(setup);
  }
    ...
    function putPosition(day, startFrom, characters, y, characterImages){
      ...
      characters.forEach(function(character){
        ...
        canvasCharacter = pairing(character, characterImages);
          ...
          if(prophet[day] == i){
              var eyeIcon = pairing('eye',characterImages )
              eyeIcon.x = canvasCharacter.x;
              eyeIcon.y = y-50;
              eyeIcon.width = widthY;
              eyeIcon.height = heightX;
              stage.addChild(eyeIcon);
              displayMsg("第"+parseInt(day+1)+"天 ","32px sans-serif","white",  canvasCharacter.x, 20);
              console.log(players[i]+'******');
              if(players[i-1]=='wolf'){
                var shocked = pairing('shocked',characterImages )
                shocked.x = canvasCharacter.x+25;
                shocked.y = y-50;
                shocked.width = widthY;
                shocked.height = heightX;
                stage.addChild(shocked);
              }
          }

          if(protect[day] == i){
              var guardIcon = pairing('protect',characterImages )
              guardIcon.x = canvasCharacter.x;
              guardIcon.y = y-50;
              guardIcon.width = widthY;
              guardIcon.height = heightX;
              guardIcon.alpha = 0.8;
              stage.addChild(guardIcon);
          }
    ...
    function pairing(character, characterImages){
      switch (character) {
        ...
        case 'lovers':
            ...
            break;
        case 'eye':
            return characterImages.eye();
            break;
        case 'protect':
            return characterImages.protect();
            break;
        case 'shocked':
            return characterImages.shocked();
            break;
        // case 'whitewolf':
        //     return characterImages.whitewolf();
        //     break;
  ...
  function setup() {
    ...
    characterImages = {
      ...
      shocked:function(){return generateImg("static/images/shocked.jpg")},
      eye:function(){return generateImg("static/images/eye.png")},
      protect:function(){return generateImg("static/images/protect.png")},
      idiot:function(){return generateImg("static/images/idiot.png")}
      // whitewolf:function(){return generateImg("static/images/whitewolf.png")}
      ...
      deadReason =  {
        ...
        // 'whitewolf':{text:'白狼', icon:characterImages.whitewolf()}
